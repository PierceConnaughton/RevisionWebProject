...
export class HeroDetailComponent implements OnInit {
  ...
  //instance of the HeroDetailComponent The "id" parameter is the 
  //id of the hero to display.
  ...
  //browser. You'll use it to navigate back to the view that 
  //navigated here.
  constructor(
